...
# main.py と同階層のモジュールを前提
from src import mdpi_parser  # 本体統合後は from pubmed_reference_resolver import mdpi_parser


TEST_DIR = Path(__file__).parent / "test_integration_149refs"
